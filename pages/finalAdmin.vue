  ...
  <section>
    ...
    <div class="container">
      ...
      <el-form :data="consul" label-width="90px" @submit.native.prevent="consulForm" size="mini">
        <el-dialog title="고객 정보" :visible.sync="consulFormDialog" width="800px" class="consul-form-dialog">
          <!-- <el-row>
          ...
          <el-row>
            ...
            <el-col style="text-align:right;">
              <el-button type="danger" @click="consulFormDialog= false">목록으로</el-button>
